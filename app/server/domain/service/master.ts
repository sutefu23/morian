...
export class UnitService {
  ...
  ): Promise<UnitType | FieldNotFoundError> {
...
export class DeliveryPlaceService {
  ...
  async getDeliveryPlaceList(): Promise<
    DeliveryPlaceType[] | FieldNotFoundError
  > {
...
export class ReasonService {
  ...
  async createReason(
    entity: ReasonType
  ): Promise<ReasonType | FieldNotFoundError> {
